...
MACAE_BAIRROS: dict[str, tuple[float, float]] = {
    ...
    "São Marcos":             (-22.395, -41.815),
    "Cancela Preta":          (-22.405, -41.835),
    ...
    "Mirante da Lagoa":       (-22.428, -41.798),
    "Imboassica":             (-22.445, -41.795),
    "Costa do Sol":           (-22.435, -41.793),
    "Riviera Fluminense":     (-22.450, -41.795),
    "Lagomar":                (-22.460, -41.798),
    "Aphaville (Costa do Sol)": (-22.450, -41.815),
    "Novo Horizonte":         (-22.420, -41.825),
}
